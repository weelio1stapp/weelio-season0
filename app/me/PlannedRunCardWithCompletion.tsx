...
import { completePlannedRun } from "@/app/p/[id]/planActions";
import type { UserRunPlan } from "@/lib/db/runPlans";

type PlannedRunCardWithCompletionProps = {
  plan: UserRunPlan;
};

export default function PlannedRunCardWithCompletion({
  plan,
}: PlannedRunCardWithCompletionProps) {
